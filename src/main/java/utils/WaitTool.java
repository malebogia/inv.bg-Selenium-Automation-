...
public class WaitTool {
	...
	public static WebElement waitForElement(WebDriver driver, final By by,
		...
		try {
			...
			driver.manage().timeouts()
					.implicitlyWait(Duration.ofSeconds(DEFAULT_WAIT_4_PAGE)); // reset
																			// implicitlyWait
	...
	public static void resetImplicitWait(WebDriver driver,
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(0)); // nullify
																		// implicitlyWait()
		driver.manage().timeouts()
				.implicitlyWait(Duration.ofSeconds(newWaittime_InSeconds)); // reset
																			// implicitlyWait
	}
	...
	public static void waitForElementVis(WebElement webElement, WebDriver driver, int seconds){
